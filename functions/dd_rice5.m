...
% param(3)   a1       0.2     0          1          amplitude of 1st component
% param(4)   nu2      3.5     1.0        10         center of 2nd component
% param(5)   sigma2   0.7     0.1        5          spread of 2nd component
% param(6)   a2       0.2     0          1          amplitude of 2nd component
% param(7)   nu3      4.0     1.0        10         center of 3rd component
% param(8)   sigma3   0.7     0.1        5          spread of 3rd component
% param(9)   a3       0.2     0          1          amplitude of 3rd component
% param(10)  nu4      5.0     1.0        10         center of 4th component
% param(11)  sigma4   0.7     0.1        5          spread of 4th component
% param(12)  a3       0.2     0          1          amplitude of 4th component
% param(13)  nu5      5.5     1.0        10         center of 5th component
% param(14)  sigma5   0.7     0.1        5          spread of 5th component
% --------------------------------------------------------------------------
%
