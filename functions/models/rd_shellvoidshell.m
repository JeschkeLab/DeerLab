%
% RD_SHELLVOIDSHELL Particles distributed on a sphere inside a spherical shell separated by a void 
%
%   info = RD_SHELLVOIDSHELL
%   Returns an (info) structure containing the specifics of the model.
%
%   P = RD_SHELLVOIDSHELL(r,param)
...
function output = rd_shellvoidshell(r,param)
