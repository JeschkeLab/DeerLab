%
% DD_FOURGAUSSIAN Sum of four Gaussian distributions parametric model
%
%   info = DD_FOURGAUSSIAN
%   Returns an (info) structure containing the specifics of the model.
%
%   P = DD_FOURGAUSSIAN(r,param)
...
function output = dd_fourgaussian(r,param)
