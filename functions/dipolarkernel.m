...
if ~isempty(ExcitationBandwidth)
    validateattributes(ExcitationBandwidth,{'numeric'},{'scalar','nonnegative'},'dipolarkernel','ExcitationBandwidth')
end
if ~isempty(Background)
    validateattributes(Background,{'numeric'},{},'dipolarkernel','Background')
end
...
validateattributes(DistanceAxis,{'numeric'},{'nonempty','increasing','nonnegative'},'dipolarkernel','DistanceAxis')
validateattributes(TimeAxis,{'numeric'},{'nonempty','increasing','nonnegative'},'dipolarkernel','TimeAxis')
