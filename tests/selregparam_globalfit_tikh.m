...
[OptRegParam,fun] = selregparam(RegParamRange,Signals,Kernels,L,'tikhonov',{'aic','aicc'});

Result1 = fitregmodel(Signals,Kernels,DistanceAxis,L,'tikhonov',OptRegParam(1),'Solver','fnnls');
Result2 = fitregmodel(Signals,Kernels,DistanceAxis,L,'tikhonov',OptRegParam(2),'Solver','fnnls');
