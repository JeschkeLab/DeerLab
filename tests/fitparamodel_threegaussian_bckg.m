...
Distribution = InputParam(7)*gaussfcn(DistanceAxis,InputParam(1),InputParam(2))/(1/sqrt(2*pi)*1/InputParam(2)) ...
    + InputParam(8)*gaussfcn(DistanceAxis,InputParam(3),InputParam(4))/(1/sqrt(2*pi)*1/InputParam(4));
    + (1 - InputParam(7) -InputParam(8))*gaussfcn(DistanceAxis,InputParam(5),InputParam(6))/(1/sqrt(2*pi)*1/InputParam(6));
