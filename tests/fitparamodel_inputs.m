...
timemodel = @(t,param)K*dd_onegaussian(r,param);
warning('off')

InitialGuess = [2 0.1];
[~,Pfit1] = fitparamodel(S,@dd_onegaussian,r,K,InitialGuess,'Solver','lsqnonlin');
...
[~,Pfit3] = fitparamodel(S,@dd_onegaussian,r,K,'Solver','lsqnonlin');

warning('on')

Pfit2 = dd_onegaussian(r,fitparam);
