...
[alpha1,F1,alphas1] = selregparam(S,K,r,'tikh','aic');
[alpha2,F2,alphas2] = selregparam(S.',K,r,'tikh','aic');
[alpha3,F3,alphas3] = selregparam(S,K,r.','tikh','aic');
[alpha4,F4,alphas4] = selregparam(S.',K,r.','tikh','aic');
