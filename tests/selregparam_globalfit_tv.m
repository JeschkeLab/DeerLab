...
[OptRegParam,fun] = selregparam(RegParamRange,Signals,Kernels,L,'tv',{'aic','aicc'});

Result1 = fitregmodel(Signals,Kernels,DistanceAxis,L,'tv',OptRegParam(1),'Solver','fnnls');
Result2 = fitregmodel(Signals,Kernels,DistanceAxis,L,'tv',OptRegParam(2),'Solver','fnnls');
