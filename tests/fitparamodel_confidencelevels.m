...
par0 = [2 0.2];
[parFit1,Pfit,parCI1] = fitparamodel(S,@dd_gauss,r,K,par0,'confidencelevel',0.95);
[parFit2,~,parCI2] = fitparamodel(S,@dd_gauss,r,K,par0,'confidencelevel',0.50);
[parFit3,~,parCI3] = fitparamodel(S,@dd_gauss,r,K,par0,'confidencelevel',0.25);
