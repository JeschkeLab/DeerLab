...
[RegParam] = selregparam(range,Signal,Kernel,RegMatrix,'aic','RegType','tv');

TikhResult1 = regularize(Signal,Kernel,RegMatrix,'tv',RegParam,'Solver','fmincon');
err(1) = any(abs(TikhResult1 - Distribution)>2e-2);
