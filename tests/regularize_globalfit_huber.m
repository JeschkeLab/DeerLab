...
Result = regularize(Signals,Kernels,L,'huber',regparam,'Solver','fnnls');
Dist1 = regularize(Signal1,Kernel1,L,'huber',regparam,'Solver','fnnls');
Dist2 = regularize(Signal2,Kernel2,L,'huber',regparam,'Solver','fnnls');
Dist3 = regularize(Signal3,Kernel3,L,'huber',regparam,'Solver','fnnls');
