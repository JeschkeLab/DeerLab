...
fit = fitbackground(data2fit,t,@td_exp,tstart,'Logfit',true);
fit2 = fitbackground(data2fit2,t,@td_exp,tstart,'Logfit',true);
fit3 = fitbackground(data2fit3,t,@td_exp,tstart,'Logfit',true);
