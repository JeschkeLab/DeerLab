...
[OptRegParam,fun] = selregparam(Ss,Ks,L,'huber',{'aic','aicc'},'Range',RegParamRange);

Result1 = fitregmodel(Ss,Ks,r,L,'huber',OptRegParam(1),'Solver','fnnls');
Result2 = fitregmodel(Ss,Ks,r,L,'huber',OptRegParam(2),'Solver','fnnls');
