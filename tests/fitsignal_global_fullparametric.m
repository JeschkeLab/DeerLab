...
% Check that fitsignal() fits multiple 4pDEER signals
rng(1)
...
V1 = dipolarsignal(t1,r,P,lam1,B1,'noiselevel',0.01);
V2 = dipolarsignal(t2,r,P,lam2,B2,'noiselevel',0.01);

[Vfit,Pfit] = fitsignal({V1,V2},{t1,t2},r,@dd_gauss,@bg_exp,@ex_4pdeer);
