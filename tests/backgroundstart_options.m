...
backgroundstart(V,t,@td_exp,'RelSearchStart',0.00001,'RelSearchEnd',0.00005);
%Check other options
backgroundstart(V,t,@td_exp,'EndCutoffPos',10);

%Control using the defaults
t0 = backgroundstart(V,t,@td_exp,'RelSearchStart',0.05,'RelSearchEnd',0.8);
