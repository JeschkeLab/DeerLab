...
[~,Pglobal] = fitparamodel(Ss,@rd_twogaussian,r,Ks);
[~,Plocal1] = fitparamodel(S1,@rd_twogaussian,r,K1);
[~,Plocal2] = fitparamodel(S2,@rd_twogaussian,r,K2);
[~,Plocal3] = fitparamodel(S3,@rd_twogaussian,r,K3);
