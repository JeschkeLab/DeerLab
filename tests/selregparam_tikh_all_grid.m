...
alphaopt1 = selregparam(S,K,'tikhonov','all','NonNegConstrained',false,'NoiseLevel',0.05,'search','grid');
alphaopt2 = selregparam(S,K,'tikhonov',{'all'},'NonNegConstrained',false,'NoiseLevel',0.05,'search','grid');
