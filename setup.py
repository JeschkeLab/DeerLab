...
def install_dependencies(develop_mode=False):
    ...
    if platform.system() == "Windows":
        ...
        subprocess.run(
            [executable, "-m", "pipwin", "install", "numpy", "--filter=mkl"],
            check=False,
        )
...
setup(
    ...
    package_dir={"deerlab": "deerlab", "deerlab.utils": "deerlab/utils"},
    ...
    cmdclass={"install": install_routine, "develop": develop_routine},
    classifiers=[
