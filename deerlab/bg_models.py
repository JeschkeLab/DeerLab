...
def hyp2f1_repro(a, b, c, z):
    ...
    """
    return gamma(b - a) * gamma(c) / (gamma(b) * gamma(c - a) * (-z) ** a) * hyp2f1(
        a, a - c + 1, a - b + 1, 1 / z
    ) + (gamma(a - b) * gamma(c)) / (gamma(a) * gamma(c - b) * (-z) ** b) * hyp2f1(
        b, b - c + 1, b - a + 1, 1 / z
    )
...
bg_hom3d.description = (
    "Background from a homogeneous distribution of spins in a 3D medium"
)
# Add parameters
bg_hom3d.conc.set(
    description="Spin concentration", lb=0.01, ub=5000, par0=50, unit="μM"
)
...
def _hom3dex_phase(t, conc, rex, lam):
    ...
    z = np.linspace(0, 1, 1000)[np.newaxis, :]
    Dt = D * t[:, np.newaxis] * 1e-6
    Ic = -ξ * (t * 1e-6) + 4 * np.pi / 3 * np.trapz(
        Dt
        * (1 - 3 * z**2)
        * sici((Dt * np.abs(1 - 3 * z**2)) / ((rex * 1e-9) ** 3))[1],
        z,
        axis=1,
    )
...
bg_hom3dex_phase.description = (
    "Phase shift from a homogeneous distribution of spins with excluded volume"
)
# Add parameters
bg_hom3dex_phase.conc.set(
    description="Spin concentration", lb=0.01, ub=5000, par0=50, unit="μM"
)
bg_hom3dex_phase.rex.set(
    description="Exclusion radius", lb=0.01, ub=20, par0=1, unit="nm"
)
...
# Add parameters
bg_homfractal.fconc.set(
    description="Fractal concentration of spins",
    lb=1e-20,
    ub=1e20,
    par0=1.0e-6,
    unit="μmol/dmᵈ",
)
bg_homfractal.fdim.set(
    description="Fractal dimensionality", lb=0.01, ub=5.99, par0=2.2, unit=""
)
    ...
    if d == 3:
        ...
        ξd = (
            ...
            * (
                ...
                * np.sin(d * pi / 6)
                * gamma(3 / 2 + d / 3)
                * hyp2f1((-3 - 2 * d) / 6, -d / 3, (3 - 2 * d) / 6, 1 / 3)
                / gamma((3 - 2 * d) / 6)
            )
        )
...
bg_homfractal_phase.fdim.set(
    description="Fractal dimensionality", lb=0.01, ub=5.99, par0=2.2, unit=""
)
bg_homfractal_phase.lam.set(
    description="Pathway amplitude", lb=0, ub=1, par0=1, unit=""
)
# Add documentation
...
# Add parameters
bg_prodstrexp.decay1.set(
    description="Decay rate of 1st component", lb=0, ub=200, par0=0.25, unit="μs⁻¹"
)
bg_prodstrexp.decay2.set(
    description="Decay rate of 2nd component", lb=0, ub=200, par0=0.25, unit="μs⁻¹"
)
bg_prodstrexp.stretch1.set(
    description="Stretch factor of 1st component", lb=0, ub=6, par0=1, unit=""
)
bg_prodstrexp.stretch2.set(
    description="Stretch factor of 2nd component", lb=0, ub=6, par0=1, unit=""
)
# Add documentation
...
# Add parameters
bg_sumstrexp.decay1.set(
    description="Decay rate of 1st component", lb=0, ub=200, par0=0.25, unit="μs⁻¹"
)
bg_sumstrexp.decay2.set(
    description="Decay rate of 2nd component", lb=0, ub=200, par0=0.25, unit="μs⁻¹"
)
bg_sumstrexp.weight1.set(
    description="Weight of the 1st component", lb=0, ub=1, par0=0.5, unit=""
)
bg_sumstrexp.stretch1.set(
    description="Stretch factor of 1st component", lb=0, ub=6, par0=1, unit=""
)
bg_sumstrexp.stretch2.set(
    description="Stretch factor of 2nd component", lb=0, ub=6, par0=1, unit=""
)
# Add documentation
...
bg_poly2.p1.set(
    description="1st order weight", lb=-200, ub=200, par0=-1, unit=r"μs\ :sup:`-1`"
)
bg_poly2.p2.set(
    description="2nd order weight", lb=-200, ub=200, par0=-1, unit=r"μs\ :sup:`-2`"
)
# Add documentation
...
bg_poly3.p3.set(
    description="3rd order weight", lb=-200, ub=200, par0=-1, unit=r"μs\ :sup:`-3`"
)
# Add documentation
