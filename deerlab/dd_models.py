...
def freedist(r):
    ...
    dd_nonparametric.addlinear(
        ...
        unit="nm⁻¹",
        normalization=lambda P: P / np.trapz(P, r),
    )
...
dd_gauss2.std1.set(
    description="1st Gaussian standard deviation", lb=0.05, ub=2.5, par0=0.2, unit="nm"
)
dd_gauss2.std2.set(
    description="2nd Gaussian standard deviation", lb=0.05, ub=2.5, par0=0.2, unit="nm"
)
...
dd_gauss3.std3.set(
    description="3rd Gaussian standard deviation", lb=0.05, ub=2.5, par0=0.2, unit="nm"
)
...
dd_gengauss.std.set(
    description="Standard deviation", lb=0.05, ub=2.5, par0=0.2, unit="nm"
)
...
# Add documentation
dd_skewgauss.__doc__ = _dd_docstring(dd_skewgauss, notes) + docstr_example(
    "dd_skewgauss"
)
...
# Parameters
dd_rice2.location1.set(
    description="1st Rician location", lb=1.0, ub=20, par0=2.5, unit="nm"
)
dd_rice2.location2.set(
    description="2nd Rician location", lb=1.0, ub=20, par0=4.5, unit="nm"
)
dd_rice2.spread1.set(
    description="1st Rician spread", lb=0.05, ub=2.5, par0=0.2, unit="nm"
)
dd_rice2.spread2.set(
    description="2nd Rician spread", lb=0.05, ub=2.5, par0=0.2, unit="nm"
)
...
def _rice3(r, location1, spread1, location2, spread2, location3, spread3):
    return _multirice3dfun(
        r, [location1, location2, location3], [spread1, spread2, spread3]
    )
...
# Parameters
dd_rice3.location1.set(
    description="1st Rician location", lb=1.0, ub=20, par0=2.5, unit="nm"
)
dd_rice3.location2.set(
    description="2nd Rician location", lb=1.0, ub=20, par0=4.5, unit="nm"
)
dd_rice3.location3.set(
    description="3rd Rician location", lb=1.0, ub=20, par0=5.5, unit="nm"
)
dd_rice3.spread1.set(
    description="1st Rician spread", lb=0.05, ub=2.5, par0=0.2, unit="nm"
)
dd_rice3.spread2.set(
    description="2nd Rician spread", lb=0.05, ub=2.5, par0=0.2, unit="nm"
)
dd_rice3.spread3.set(
    description="3rd Rician spread", lb=0.05, ub=2.5, par0=0.2, unit="nm"
)
...
def _randcoil(r, Nres, scaling, length):
    rsq = (
        6 * (length * Nres**scaling) ** 2
    )  # mean square end-to-end distance from radius of gyration
...
# Parameters
dd_randcoil.Nres.set(
    description="Number of residues", lb=2.0, ub=1000, par0=50, unit=""
)
dd_randcoil.scaling.set(
    description="Segment length", lb=0.1, ub=0.4, par0=0.2, unit="nm"
)
dd_randcoil.length.set(
    description="Scaling exponent", lb=0.33, ub=1.00, par0=0.602, unit=""
)
# Add documentation
...
# Parameters
dd_shell.radius.set(
    description="Inner shell radius", lb=0.1, ub=20, par0=1.5, unit="nm"
)
dd_shell.thickness.set(
    description="Shell thickness", lb=0.1, ub=20, par0=0.5, unit="nm"
)
# Add documentation
...
dd_spherepoint.description = (
    "One particle distanced from particles uniformly distributed on a sphere"
)
# Parameters
dd_spherepoint.radius.set(
    description="Sphere radius", lb=0.1, ub=20, par0=1.5, unit="nm"
)
dd_spherepoint.dist.set(
    description="Distance to point", lb=0.1, ub=20, par0=3.5, unit="nm"
)
# Add documentation
dd_spherepoint.__doc__ = _dd_docstring(dd_spherepoint, notes) + docstr_example(
    "dd_spherepoint"
)
...
# Parameters
dd_spheresurf.radius.set(
    description="Sphere radius", lb=0.1, ub=20, par0=2.5, unit="nm"
)
# Add documentation
dd_spheresurf.__doc__ = _dd_docstring(dd_spheresurf, notes) + docstr_example(
    "dd_spheresurf"
)
...
# Parameters
dd_shellshell.radius.set(
    description="Inner shell radius", lb=0.1, ub=20, par0=1.5, unit="nm"
)
dd_shellshell.thickness1.set(
    description="Inner shell thickness", lb=0.1, ub=20, par0=0.5, unit="nm"
)
dd_shellshell.thickness2.set(
    description="Outer shell thickness", lb=0.1, ub=20, par0=0.5, unit="nm"
)
# Add documentation
dd_shellshell.__doc__ = _dd_docstring(dd_shellshell, notes) + docstr_example(
    "dd_shellshell"
)
...
dd_shellsphere.description = (
    "Particles uniformly distributed on a sphere and on an outer spherical shell."
)
# Parameters
dd_shellsphere.radius.set(
    description="Inner shell radius", lb=0.1, ub=20, par0=1.5, unit="nm"
)
dd_shellsphere.thickness.set(
    description="Inner shell thickness", lb=0.1, ub=20, par0=0.5, unit="nm"
)
# Add documentation
dd_shellsphere.__doc__ = _dd_docstring(dd_shellsphere, notes) + docstr_example(
    "dd_shellsphere"
)
...
# Parameters
dd_shellvoidshell.radius.set(
    description="Inner shell radius", lb=0.1, ub=20, par0=0.75, unit="nm"
)
dd_shellvoidshell.thickness1.set(
    description="Inner shell thickness", lb=0.1, ub=20, par0=1.0, unit="nm"
)
dd_shellvoidshell.thickness2.set(
    description="Outer shell thickness", lb=0.1, ub=20, par0=1.0, unit="nm"
)
dd_shellvoidshell.separation.set(
    description="Shell-shell separation", lb=0.1, ub=20, par0=0.5, unit="nm"
)
# Add documentation
dd_shellvoidshell.__doc__ = _dd_docstring(dd_shellvoidshell, notes) + docstr_example(
    "dd_shellvoidshell"
)
...
# Parameters
dd_shellvoidsphere.radius.set(
    description="Sphere radius", lb=0.1, ub=20, par0=1.5, unit="nm"
)
dd_shellvoidsphere.thickness.set(
    description="Outer shell thickness", lb=0.1, ub=20, par0=1.0, unit="nm"
)
dd_shellvoidsphere.separation.set(
    description="Shell-sphere separation", lb=0.1, ub=20, par0=0.5, unit="nm"
)
# Add documentation
dd_shellvoidsphere.__doc__ = _dd_docstring(dd_shellvoidsphere, notes) + docstr_example(
    "dd_shellvoidsphere"
)
...
def _wlc(r, L, Lp):
    ...
    P[idx] = (
        ...
        * kappa
        / (4 * np.pi)
        * (
            np.pi**2 * (-1) ** 2 * np.exp(-kappa * np.pi**2 * (1 - rcrit))
            + np.pi**2 * 4 * (-1) ** 3 * np.exp(-kappa * np.pi**2 * 4 * (1 - rcrit))
        )
    )
    ...
    P[idx] = (
        kappa
        / (4 * np.pi * 2 * np.sqrt(np.pi))
        * (
            (
                1
                / (kappa * (1 - rcrit)) ** (3 / 2)
                * np.exp(-((1 - 1 / 2) ** 2) / (kappa * (1 - rcrit)))
                * (4 * ((1 - 1 / 2) / np.sqrt(kappa * (1 - rcrit))) ** 2 - 2)
            )
            + 1
            / (kappa * (1 - rcrit)) ** (3 / 2)
            * np.exp(-((2 - 1 / 2) ** 2) / (kappa * (1 - rcrit)))
            * (4 * ((2 - 1 / 2) / np.sqrt(kappa * (1 - rcrit))) ** 2 - 2)
        )
    )
...
# Parameters
dd_wormchain.contour.set(
    description="Contour length", lb=1.5, ub=10, par0=3.7, unit="nm"
)
dd_wormchain.persistence.set(
    description="Persistence length", lb=2, ub=100, par0=10, unit="nm"
)
# Add documentation
dd_wormchain.__doc__ = _dd_docstring(dd_wormchain, notes) + docstr_example(
    "dd_wormchain"
)
...
dd_wormgauss.description = (
    "Worm-like chain model near the rigid limit with Gaussian convolution."
)
# Parameters
dd_wormgauss.contour.set(
    description="Contour length", lb=1.5, ub=10, par0=3.7, unit="nm"
)
dd_wormgauss.persistence.set(
    description="Persistence length", lb=2, ub=100, par0=10, unit="nm"
)
dd_wormgauss.std.set(
    description="Gaussian standard deviation", lb=0.01, ub=5, par0=0.2, unit="nm"
)
# Add documentation
dd_wormgauss.__doc__ = _dd_docstring(dd_wormgauss, notes) + docstr_example(
    "dd_wormgauss"
)
