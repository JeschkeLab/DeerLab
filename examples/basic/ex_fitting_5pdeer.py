...
Bfcn = (
    lambda lam1, lam2, reftime1, reftime2, conc: results.P_scale
    * (1 - lam1 - lam2)
    * dl.bg_hom3d(t - reftime1, conc, lam1)
    * dl.bg_hom3d(t - reftime2, conc, lam2)
)
Bfit = Bfcn(
    results.lam1, results.lam2, results.reftime1, results.reftime2, results.conc
)
...
plt.plot(
    ...
    color=violet,
    alpha=0.5,
    label="Unmodulated contribution",
)
