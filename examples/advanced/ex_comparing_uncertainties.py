...
ax[0].fill_between(
    r, Pci50_cm[:, 0], Pci50_cm[:, 1], color="tab:red", linestyle="None", alpha=0.45
)
ax[0].fill_between(
    r, Pci95_cm[:, 0], Pci95_cm[:, 1], color="tab:red", linestyle="None", alpha=0.25
)

ax[1].plot(r, results_bs.P, color=violet, linewidth=1)
ax[1].fill_between(
    r, Pci50_bs[:, 0], Pci50_bs[:, 1], color=violet, linestyle="None", alpha=0.45
)
ax[1].fill_between(
    r, Pci95_bs[:, 0], Pci95_bs[:, 1], color=violet, linestyle="None", alpha=0.25
)
