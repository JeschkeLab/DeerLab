...
``param(3)``   :math:`a_1`                  0.2     0          1          1st Gaussian amplitude
...
``param(6)``   :math:`a_2`                  0.2     0          1          2nd Gaussian amplitude
...
``param(9)``   :math:`a_3`                  0.2     0          1          3rd Gaussian amplitude
...
``param(12)``  :math:`a_4`                  0.2     0          1          4th Gaussian amplitude
...
``param(15)``  :math:`a_5`                  0.2     0          1          5th Gaussian amplitude
============== ======================== ========= ======== ========= =====================================
