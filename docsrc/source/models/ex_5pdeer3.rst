...
.. autofunction:: deerlab.ex_models.ex_5pdeer3
...
``param[4]``   :math:`T_0^{(2)}`           5.0                0       20         2nd modulated pathway, refocusing time (μs)
``param[3]``   :math:`\lambda_3`           0.1                0       1          3rd modulated pathway, amplitude
