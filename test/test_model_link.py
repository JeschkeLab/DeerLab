...
def test_link_name():
    ...
    assert (
        hasattr(linkedmodel, "mean")
        and not hasattr(linkedmodel, "mean1")
        and not hasattr(linkedmodel, "mean2")
    )
...
def test_link_multiple():
    ...
    linkedmodel = link(model, mean1=["mean1", "mean2"], std2=["std2", "std3"])
...
def test_link_fit():
    ...
    linkedmodel = link(model, mean=["mean1", "mean2"], std=["std1", "std2"])
...
def test_link_linear_name():
    ...
    assert (
        hasattr(linkedmodel, "amp")
        and not hasattr(linkedmodel, "amp1")
        and not hasattr(linkedmodel, "amp3")
    )
...
def test_vec_link_name():
    ...
    assert (
        hasattr(linkedmodel, "vec")
        and not hasattr(linkedmodel, "vec1")
        and not hasattr(linkedmodel, "vec2")
    )
