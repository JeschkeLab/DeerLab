...
import numpy as np
from deerlab import rlls,dipolarkernel, regoperator, whitegaussnoise
...
#============================================================
    ...
    fit = rlls(V,K,lb=np.zeros_like(r),solver=solver,uq=False)
...
#============================================================
    ...
    fit = rlls(V,K,lb=np.zeros_like(r))
...
#============================================================
    ...
    fit = rlls([V1,V2],[K1,K2],lb=np.zeros_like(r))
...
#============================================================
    ...
    fit = rlls(V,K,lb=np.zeros_like(r),noiselvl=sigma)
    stats = fit.stats
...
#============================================================
    ...
    fit = rlls(V,K,tol=1e-9,maxiter=2e3,lb=np.zeros_like(r))
...
# ======================================================================
    ...
    fit = rlls(y,A,reg=False)
    a_ci = [fit.scale*fit.paramUncert.ci(cov[i])[0,:] for i in range(3)]
    b_ci = [fit.scale*fit.paramUncert.ci(cov[i])[1,:] for i in range(3)]
...
# ======================================================================
    ...
    fit1 = rlls([V1,V2],[K,K],lb=np.zeros_like(r),weights=[1,1e-10])
    fit2 = rlls([V1,V2],[K,K],lb=np.zeros_like(r),weights=[1e-10,1])
...
# ======================================================================
    ...
    fit = rlls([V1,V2],[K,K],lb=np.zeros_like(r))
